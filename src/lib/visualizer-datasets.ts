...
export const TRAFFIC_NODES: Node[] = [
  ...
  },
  {
    ...
    position: { x: 200, y: 10 },
    className: 'bg-slate-800 text-white border border-slate-900 font-mono text-[10px] font-bold p-4 rounded-sm',
  ...
  },
  {
    ...
    className: 'bg-white border border-slate-300 font-mono text-[10px] font-semibold text-slate-800 p-4 rounded-sm',
  ...
  },
  {
    ...
    className: 'bg-indigo-50 border border-indigo-200 text-indigo-600 font-mono text-[10px] font-bold p-4 rounded-sm',
    targetPosition: Position.Top, sourcePosition: Position.Bottom,
  },
  {
    id: 's3-origin',
    ...
    className: 'bg-emerald-50 border border-emerald-200 text-emerald-700 font-mono text-[10px] font-semibold p-4 rounded-sm',
...
export const TRAFFIC_EDGES: Edge[] = [
  {
    ...
    labelStyle: { fontFamily: 'monospace', fontSize: 8, fill: '#64748b', fontWeight: 'bold' },
    style: { stroke: '#475569', strokeWidth: 2 },
  },
  {
    id: 't2', source: 'cf-edge', target: 's3-origin', type: 'straight', animated: true,
    label: 'Assets (/assets/*)',
    labelStyle: { fontFamily: 'monospace', fontSize: 8, fill: '#059669', fontWeight: 'bold' },
    style: { stroke: '#10b981', strokeWidth: 1.5 },
  },
  {
    id: 't3', source: 'cf-edge', target: 'ec2-origin', type: 'straight', animated: true,
    label: 'Default Route',
    labelStyle: { fontFamily: 'monospace', fontSize: 8, fill: '#4f46e5', fontWeight: 'bold' },
...
export const PIPELINE_NODES: Node[] = [
  {
    ...
    position: { x: 200, y: 0 },
    className: 'bg-slate-50 border border-slate-300 text-slate-800 font-mono text-[10px] font-semibold p-4 rounded-sm',
    sourcePosition: Position.Bottom,
  },
  {
    id: 'actions',
    ...
    className: 'bg-white border border-slate-300 text-slate-800 font-mono text-[10px] font-semibold p-4 rounded-sm',
    targetPosition: Position.Top, sourcePosition: Position.Bottom,
  },
  {
    id: 'ghcr',
  ...
  },
  {
    ...
    className: 'bg-emerald-50 border border-emerald-200 text-emerald-700 font-mono text-[10px] font-semibold p-4 rounded-sm shadow-none',
    targetPosition: Position.Top, sourcePosition: Position.Bottom,
  },
  {
    id: 'ec2-ssm',
  ...
  },
  {
    ...
    className: 'bg-white border border-slate-300 text-slate-800 font-mono text-[10px] font-semibold p-4 rounded-sm shadow-none',
    targetPosition: Position.Top,
  },
];
...
export const PIPELINE_EDGES: Edge[] = [
  ...
  },
  {
    ...
    label: 'Docker Pull',
    labelStyle: { fontFamily: 'monospace', fontSize: 8, fill: '#64748b' },
